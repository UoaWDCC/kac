...
export default function AdminDashboard({ activeSection }: AdminDashboardProps) {
    const section =
        activeSection === "members"
            ? {
                description: "Search membership records, check payment year, and find student details quickly.",
                icon: UserRoundCheck,
                label: "Members",
                title: "Member Details",
            }
            : {
                description: "Review contact form messages and reply to recent enquiries.",
                icon: Inbox,
                label: "Inbox",
